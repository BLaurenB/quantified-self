  ...
  fetch('https://vast-retreat-17218.herokuapp.com/api/v1/foods')
    ...
    .then(myJson => {
      ...
      <tr>
        <td>${obj.name}</td>
        <td>${obj.calories}</td>
        <td class="delete-food-button"><img src="http://files.softicons.com/download/toolbar-icons/vista-base-software-icons-2-by-icons-land/png/256x256/DeleteRed.png" width="30" height="auto" id='${obj.id}'></a></td>
      </tr>
      `
        )
      })
